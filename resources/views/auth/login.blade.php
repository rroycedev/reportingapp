  ...
  <div class="row align-items-center">
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3" style="border: 1px solid gray;-webkit-box-shadow: 5px 5px 15px 1px #000000;box-shadow: 5px 5px 15px 1px #000000;margin-top: 70%;">
